Pod::Spec.new do |spec|
	...
	spec.source  = { :http => "https://censiodev.jfrog.io/censiodev/cocoapods-local/TrueMotionRecording/TrueMotionRecording-1.1.0-SNAPSHOT-2415.tar.gz" }
    ...
    spec.dependency 'TrueMotionSensorEngineAdapter', '1.1.0-SNAPSHOT-2415'
end